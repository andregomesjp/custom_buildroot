...
HOST_BOOST_FLAGS = --without-icu --with-toolset=gcc \
	--without-libraries=$(subst $(space),$(comma),atomic context \
	contract exception filesystem graph graph_parallel \
	iostreams locale math mpi python \
	serialization signals test type_erasure \
	wave)
